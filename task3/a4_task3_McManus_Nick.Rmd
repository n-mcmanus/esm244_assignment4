...
biden_cloud <- ggplot(data = biden_top_30, aes(label = word)) +
  ...
  scale_color_gradientn(colors = c("lightblue", "dodgerblue4")) +
  theme_minimal()
...
**Figure 1:** The top 30 most frequently used words in the past two inaugural addresses, where increased frequency is indicated by text size and color. The top word cloud in blue displays the most common words in Biden's address, while the bottom displays Trump's most commonly used words in red.
